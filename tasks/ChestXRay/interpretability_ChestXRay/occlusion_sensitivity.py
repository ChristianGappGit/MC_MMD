...
from interpretability_ChestXRay.colorize_text import colorize_tokens2, colorize_tokens
from interpretability_ChestXRay.colorize_img import colorize_img
...
class OcclusionSensitivity:
    ...
    def __call__(
        ...
        with eval_mode(self.nn_module):
            ...
            from interpretability_ChestXRay.utils import sliding_window_inference #adapted version of monai's sliding_window_inference
